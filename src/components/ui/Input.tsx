      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              'w-full bg-white border border-[#E8DDD0] rounded-xl text-sm text-espresso placeholder:text-brown-400',
    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          id={selectId}
          className={cn(
            'w-full bg-white border border-[#E8DDD0] rounded-xl text-sm text-espresso',
            'px-3 py-2 transition-all duration-150',
            'hover:border-beige-300 focus:outline-none focus:border-terracotta-400 focus:ring-2 focus:ring-terracotta-400/20',
